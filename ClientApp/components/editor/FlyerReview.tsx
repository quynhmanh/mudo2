...
export default class Canvas extends PureComponent<IProps, IState> {
  ...
  render () {
    return <div id="alo2" className="flyer eNf6210Ehjw49xuxCsPpk" 
    style={{
        width: '328px', 
        height: '218px', 
        position: 'relative', 
    ...
    <div>
        <div className="jPqjdkeSY9qVUI2aXLxBM" style={{width: '100%', height: '100%'}}>
            ...
            </div><img src="https://static.canva.com/web/images/b45eaeddd0bb8ad910b151e3cded5543.png" className="_3ABwoP9VfcpIZ-Qr_klynj" style={{zIndex: 9999999, transform: 'translateZ(0)', width: '100%', height: '100%', position: 'absolute', left: 0, top: 0}} /></div>
    </div>
</div>
  }
}