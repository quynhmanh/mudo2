          ...
          <div className="container">
            <div className="unblurred">
              ...
              >
                ...
                >
                  <label className="unblurred">Buffer size:</label>
                  ...
                  <div data-v-f65674dc className="editor-upper-controls">
                    <button
                      data-v-f65674dc
                      title="Close"
                      className="editor-button close-button"
                    >
                      <i data-v-f65674dc className="icon-cross" />
                    </button>{" "}
                    <div
                      data-v-f65674dc
                      className="editor-button-group hidden-xs"
                    >
                      <button
                        onClick={this.handleZoomOut.bind(this)}
                        data-v-f65674dc
                        title="Zoom out"
                        className="editor-button zoom-out-button"
                      >
                        <i data-v-f65674dc className="icon-minus" />-
                      </button>{" "}
                      <button
                        data-v-f65674dc
                        title="Set zoom to 100%"
                        className="editor-button zoom-restore-button"
                      >
                        180%
                      </button>{" "}
                      <button
                        ...
                        data-v-f65674dc
                        title="Zoom in"
                        className="editor-button zoom-in-button"
                      >
                        <i data-v-f65674dc className="icon-plus" />+
                      </button>
                    </div>{" "}
                    <div data-v-f65674dc className="editor-button-group">
                      <button
                        data-v-f65674dc
                        title="Undo"
                        className="editor-button undo-button"
                      >
                        <i data-v-f65674dc className="icon-undo2" />
                      </button>{" "}
                      <button
                        data-v-f65674dc
                        title="Redo"
                        className="editor-button redo-button"
                      >
                        <i data-v-f65674dc className="icon-redo2" />
                      </button>
                    </div>{" "}
                    <button
                      data-v-f65674dc
                      title="Download"
                      className="editor-button download-button hidden-sm hidden-md hidden-lg"
                    >
                      <i data-v-f65674dc className="icon-download2" />
                    </button>
                  </div>
