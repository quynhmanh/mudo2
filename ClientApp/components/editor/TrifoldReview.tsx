  ...
  render () {
    ...
    <div>
        <div className="jPqjdkeSY9qVUI2aXLxBM" style={{width: '100%', height: '100%'}}>
            ...
            </div><img src="https://static.canva.com/web/images/a62e85d9dee1f68b78bbe1474d8540ae.png" className="_3ABwoP9VfcpIZ-Qr_klynj" style={{transform: 'translateZ(0)', width: '100%', height: '100%', position: 'absolute', left: 0, top: 0}} /></div>
    </div>
</div>
  }
}