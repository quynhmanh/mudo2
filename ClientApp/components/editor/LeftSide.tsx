    ...
    <div
        ...
        >
          <input 
            ...
            onLoad={(data) => {}}
            onLoadedData={(data) => {}}
            onChange={(e) => {this.props.selectedTab === SidebarTab.Video ? this.uploadVideo() :
              this.props.selectedTab === SidebarTab.Font ? this.uploadFont(e) :
              this.uploadImage(this.props.selectedTab === SidebarTab.Image ? TemplateType.Image :
                (this.props.selectedTab === SidebarTab.Upload ? TemplateType.UserUpload : 
                (this.props.selectedTab === SidebarTab.Background ? TemplateType.BackgroundImage :
                  (this.props.selectedTab === SidebarTab.RemovedBackgroundImage ? TemplateType.RemovedBackgroundImage : TemplateType.RemovedBackgroundImage))), false, e)}}
            style={{
              bottom: 0,
            }}
            />
          <button
            ...
            onClick={
              ...
              this.uploadImage.bind(this, this.props.selectedTab === SidebarTab.Image ? TemplateType.Image : TemplateType.BackgroundImage, false)}>
              Upload
          </button>
          <button
          style={{
    ...
    >
        <div
          style={{
            ...
            transform: this.props.selectedTab !== SidebarTab.Image && `translate3d(0px, calc(-${this.props.selectedTab > SidebarTab.Image ? 40 : -40}px), 0px)`,
        ...
        <div
          style={{
            ...
            width: '347px',
            transition: 'transform .25s ease-in-out,opacity .25s ease-in-out,-webkit-transform .25s ease-in-out',
            transform: this.props.selectedTab !== SidebarTab.Text && `translate3d(0px, calc(${this.props.selectedTab < SidebarTab.Text ? 40 : -40}px), 0px)`,
            top: '10px',
        ...
        <div style={{ color: "white" }}>
          ...
          style={{
            ...
            width: '347px',
            transition: 'transform .25s ease-in-out,opacity .25s ease-in-out,-webkit-transform .25s ease-in-out',
            transform: this.props.selectedTab !== SidebarTab.Template && `translate3d(0px, calc(${this.props.selectedTab < SidebarTab.Template ? 40 : -40}px), 0px)`,
            top: '10px',
      ...
      <div
          style={{
            opacity: this.props.selectedTab === SidebarTab.Background ? 1 : 0,
            position: 'absolute',
            width: '347px',
            color: "white",
            overflow: "scroll",
            transition: 'transform .25s ease-in-out,opacity .25s ease-in-out,-webkit-transform .25s ease-in-out',
            transform: this.props.selectedTab !== SidebarTab.Background && `translate3d(0px, calc(${this.props.selectedTab < SidebarTab.Background ? 40 : -40}px), 0px)`,
            top: '10px',
...
<ImagePicker
        ...
        <div
          style={{
            ...
            overflow: "scroll",
            transition: 'transform .25s ease-in-out,opacity .25s ease-in-out,-webkit-transform .25s ease-in-out',
            transform: this.props.selectedTab !== SidebarTab.Font && `translate3d(0px, calc(${this.props.selectedTab < SidebarTab.Font ? 40 : -40}px), 0px)`,
            top: '10px',
...
<path d="m22,0c-12.2,0-22,9.8-22,22s9.8,22 22,22 22-9.8 22-22-9.8-22-22-22zm12.7,15.1l0,0-16,16.6c-0.2,0.2-0.4,0.3-0.7,0.3-0.3,0-0.6-0.1-0.7-0.3l-7.8-8.4-.2-.2c-0.2-0.2-0.3-0.5-0.3-0.7s0.1-0.5 0.3-0.7l1.4-1.4c0.4-0.4 1-0.4 1.4,0l.1,.1 5.5,5.9c0.2,0.2 0.5,0.2 0.7,0l13.4-13.9h0.1c0.4-0.4 1-0.4 1.4,0l1.4,1.4c0.4,0.3 0.4,0.9 0,1.3z"/>
      ...
      <div
          style={{
            opacity: this.props.selectedTab === SidebarTab.RemovedBackgroundImage ? 1 : 0,
            position: 'absolute',
            width: '347px',
            color: "white",
            overflow: "scroll",
            transition: 'transform .25s ease-in-out,opacity .25s ease-in-out,-webkit-transform .25s ease-in-out',
            transform: this.props.selectedTab !== SidebarTab.RemovedBackgroundImage && `translate3d(0px, calc(${this.props.selectedTab < SidebarTab.RemovedBackgroundImage ? 40 : -40}px), 0px)`,
            top: '10px',
            zIndex: this.props.selectedTab !== SidebarTab.RemovedBackgroundImage && -1,
            height: '100%',
          }}
        >
      <InfiniteScroll
      ...
      >
        ...
        <div
          style={{
            ...
            overflow: "scroll",
            transition: 'transform .25s ease-in-out,opacity .25s ease-in-out,-webkit-transform .25s ease-in-out',
            transform: this.props.selectedTab !== SidebarTab.Element && `translate3d(0px, calc(${this.props.selectedTab < SidebarTab.Element ? 40 : -40}px), 0px)`,
            top: '10px',
        ...
        <div
          style={{
            ...
            overflow: "scroll",
            transition: 'transform .25s ease-in-out,opacity .25s ease-in-out,-webkit-transform .25s ease-in-out',
            transform: this.props.selectedTab !== SidebarTab.Video && `translate3d(0px, calc(${this.props.selectedTab < SidebarTab.Video ? 40 : -40}px), 0px)`,
            top: '10px',
      ...
      <div
          style={{
            ...
            overflow: "scroll",
            transition: 'transform .25s ease-in-out,opacity .25s ease-in-out,-webkit-transform .25s ease-in-out',
            transform: this.props.selectedTab !== SidebarTab.Upload && `translate3d(0px, calc(${this.props.selectedTab < SidebarTab.Upload ? 40 : -40}px), 0px)`,
            top: '10px',
