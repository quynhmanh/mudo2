                ...
                <div className='popup_inner unblurred' 
                  style={{
                    ...
                    <div style={{
                      ...
                      <div className="leftSide___2aU6- loginWrapper___204mQ"><div>
                      <svg style={{
    transform: 'scale(0.7)',
    transformOrigin: '0 0',
